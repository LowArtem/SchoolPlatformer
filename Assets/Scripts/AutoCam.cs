...
namespace UnityStandardAssets.Cameras
{
    ...
    public class AutoCam : PivotBasedCameraRig
    {
        ...
        [SerializeField] private float m_TargetVelocityLowerLimit = 3f;// the minimum velocity above which the camera turns towards the object's velocity. Below this we use the object's forward direction.
